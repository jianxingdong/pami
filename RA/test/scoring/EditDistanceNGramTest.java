...
public class EditDistanceNGramTest {
	...
	public EditDistanceNGramTest() {
		...
		//String q = "i'd like to find the cheapest flight from washington dc to atlanta", pos = "i'd like to find the cheapest flight from washington dc to atlanta", ne = "O O O O O cost_relative O O city_name state_code O city_name";
	...
	@Test
	public void q3() {
		assertEquals(1 - 5f / 11, matcher.getMatchScore(
	...
	@Test
	public void q5() {
		assertEquals(1 - 2f / 7, matcher.getMatchScore(
	...
	@Test
	public void q7(){
		assertEquals(1, matcher.getMatchScore(
